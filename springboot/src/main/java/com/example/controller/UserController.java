...
public class UserController {
    ...
    @PostMapping("/add")
    public Result add(@RequestBody User user) { // @RequestBody 接受前端传来的 json 数据
        userService.add(user);
        return Result.success();
    }

    @PutMapping("/update")
    public Result update(@RequestBody User user) { // @RequestBody 接受前端传来的 json 数据
    ...
    public Result deleteBatch(@RequestBody List<User> list) { // @RequestBody 接受前端传来的 json 数据
