<template>
  <div class="bg">
    <div style="width: 350px; background-color: white; opacity: 0.9; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1); padding: 40px 20px">
      <el-form status-icon ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <div style="margin-bottom: 20px">
          <el-button style="width: 100%" size="large" type="success" @click="register">注册</el-button>
        </div>
        <div style="text-align: right">
          已经有账号? 请<a style="color: #31bf00" href="/login">登录</a>
        </div>
      </el-form>
    </div>
  </div>
...
.bg {
  ...
  align-items: center;
  overflow: hidden;
  background-image: url("@/assets/imgs/ht1.png");
