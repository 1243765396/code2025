<template>
  <div class="card" style="width: 50%">
    ...
    <el-form status-icon ref="formRef" :rules="data.rules" :model="data.user" label-width="80px" style="padding: 20px 30px 10px 0">
...
const data = reactive({
  ...
  user: {
    ...JSON.parse(localStorage.getItem('code_user') || '{}'), // 保留用户其他信息
    password: '',       // 原密码手动输入
    newPassword: '',    // 新密码
    new2Password: ''    // 确认密码
  },
